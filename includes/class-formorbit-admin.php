...
class Webform_Admin {
    ...
    public function assets($hook) {
        ...
        wp_enqueue_style('webform-field-previews', WEBFORM_URL . 'assets/css/field-previews.css', array('webform-admin'), WEBFORM_VERSION);
        ...
        <div class="wrap webform-wrap webform-builder-wrap">
            ...
            <div class="webform-builder">
                ...
                <aside class="webform-properties">
                    ...
                    <?php do_action('webform_builder_pro_style_controls', $settings); ?>
                    </div>
                    ...
                    <div class="webform-property-panel" data-panel="integrations"><h2><?php esc_html_e('Integrations', 'formorbit'); ?></h2><?php if ($this->is_pro_active()) : do_action('webform_builder_integrations_panel', $form_id); else : ?><p class="description"><?php esc_html_e('Business integrations are provided by the separately distributed FormOrbit Pro add-on.', 'formorbit'); ?></p><a class="button" href="<?php echo esc_url($this->upgrade_url('integrations-tab')); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e('Learn about FormOrbit Pro', 'formorbit'); ?></a><?php endif; ?></div>
    ...
    public function tools_page() {
        ...
        <?php if ($active_tab === 'transfer') : ?><div class="webform-transfer-grid">
            ...
            <div><?php do_action('webform_import_export_tools', $forms); ?><?php if (!$this->is_pro_active()) : ?><div class="webform-settings-card webform-export-pro-card"><span class="webform-pro-badge"><?php esc_html_e('FORMORBIT PRO', 'formorbit'); ?></span><h2><?php esc_html_e('Form export add-on', 'formorbit'); ?></h2><p><?php esc_html_e('The separately distributed FormOrbit Pro add-on provides JSON, CSV, and XML form exports.', 'formorbit'); ?></p><a class="button" href="<?php echo esc_url($this->upgrade_url('form-export')); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e('Learn about FormOrbit Pro', 'formorbit'); ?></a></div><?php endif; ?></div>
        </div><?php else : ?>
