...
class Webform_Admin {
    ...
    public function menu() {
        ...
        add_submenu_page('webform', __('All Forms', 'formorbit'), __('All Forms', 'formorbit'), 'manage_options', 'webform', array($this, 'forms_page'), 0);
        add_submenu_page('webform', __('Add New', 'formorbit'), __('Add New', 'formorbit'), 'manage_options', 'webform-builder', array($this, 'builder_page'), 1);
        add_submenu_page('webform', __('Form Templates', 'formorbit'), __('Templates', 'formorbit'), 'manage_options', 'webform-templates', array($this, 'templates_page'), 3);
        add_submenu_page('webform', __('Entries', 'formorbit'), __('Entries', 'formorbit'), 'manage_options', 'webform-entries', array($this, 'entries_page'), 4);
        add_submenu_page('webform', __('Import and Export Forms', 'formorbit'), __('Import / Export', 'formorbit'), 'manage_options', 'webform-import', array($this, 'import_page'), 5);
        add_submenu_page('webform', __('FormOrbit Settings', 'formorbit'), __('Settings', 'formorbit'), 'manage_options', 'webform-settings', array($this, 'settings_page'), 6);
        if (!$this->is_pro_active()) {
            add_submenu_page('webform', __('FormOrbit Pro', 'formorbit'), __('Upgrade to Pro', 'formorbit'), 'manage_options', 'webform-pro', array($this, 'pro_page'), 7);
        }
    }
    ...
    public function forms_page() {
        ...
        <div class="wrap webform-wrap">
            <div class="webform-page-head">
                ...
                <a class="button button-primary webform-create-button" href="<?php echo esc_url(admin_url('admin.php?page=webform-builder')); ?>"><span class="dashicons dashicons-plus-alt2"></span><?php esc_html_e('Create form', 'formorbit'); ?></a>
            </div>
            <div class="webform-card webform-list-card">
                <div class="webform-list-toolbar">
                    <nav class="webform-list-tabs" aria-label="<?php esc_attr_e('Form views', 'formorbit'); ?>">
                        <a href="<?php echo esc_url(admin_url('admin.php?page=webform')); ?>" class="<?php echo $current_view === 'all' ? 'is-active' : ''; ?>"><span class="dashicons dashicons-feedback"></span><?php esc_html_e('All forms', 'formorbit'); ?><strong><?php echo esc_html($active_count); ?></strong></a>
                        <a href="<?php echo esc_url(admin_url('admin.php?page=webform&form_status=trash')); ?>" class="<?php echo $current_view === 'trash' ? 'is-active' : ''; ?>"><span class="dashicons dashicons-trash"></span><?php esc_html_e('Trash', 'formorbit'); ?><strong><?php echo esc_html($trash_count); ?></strong></a>
                    </nav>
                        ...
                        <tr data-form-title="<?php echo esc_attr(strtolower($form->post_title . ' ' . $form->ID)); ?>">
                            <td class="column-primary" data-colname="<?php esc_attr_e('Form', 'formorbit'); ?>"><div class="webform-form-cell"><span class="webform-form-icon"><span class="dashicons dashicons-feedback"></span></span><div class="webform-form-summary"><strong class="webform-form-title"><?php if ($current_view === 'trash') : ?><?php echo esc_html($form->post_title); ?><?php else : ?><a class="row-title" href="<?php echo esc_url($edit_url); ?>"><?php echo esc_html($form->post_title); ?></a><a class="webform-title-preview" href="<?php echo esc_url($preview_url); ?>" target="_blank" rel="noopener noreferrer" title="<?php esc_attr_e('Preview form', 'formorbit'); ?>" aria-label="<?php esc_attr_e('Preview form', 'formorbit'); ?>"><span class="dashicons dashicons-visibility" aria-hidden="true"></span></a><?php endif; ?></strong><small><?php echo esc_html(sprintf(_n('ID %1$d · %2$d stage', 'ID %1$d · %2$d stages', $stage_count, 'formorbit'), $form->ID, $stage_count)); ?></small>
                                <?php if ($current_view === 'trash') : ?>
                                    <div class="row-actions"><span><a href="<?php echo esc_url(wp_nonce_url(admin_url('admin-post.php?action=webform_restore_form&form_id=' . $form->ID), 'webform_restore_' . $form->ID)); ?>"><span class="dashicons dashicons-undo"></span><?php esc_html_e('Restore', 'formorbit'); ?></a></span><span class="delete"><a onclick="return confirm('<?php echo esc_js(__('Permanently delete this form and all of its entries?', 'formorbit')); ?>')" href="<?php echo esc_url(wp_nonce_url(admin_url('admin-post.php?action=webform_permanently_delete_form&form_id=' . $form->ID), 'webform_permanently_delete_' . $form->ID)); ?>"><span class="dashicons dashicons-trash"></span><?php esc_html_e('Delete permanently', 'formorbit'); ?></a></span></div>
                                <?php else : ?>
                                    <div class="row-actions"><span><a href="<?php echo esc_url($edit_url); ?>"><span class="dashicons dashicons-edit"></span><?php esc_html_e('Edit', 'formorbit'); ?></a></span><span><a href="<?php echo esc_url(add_query_arg('panel', 'confirmation', $edit_url)); ?>"><span class="dashicons dashicons-admin-generic"></span><?php esc_html_e('Settings', 'formorbit'); ?></a></span><span><a href="<?php echo esc_url(wp_nonce_url(admin_url('admin-post.php?action=webform_duplicate_form&form_id=' . $form->ID), 'webform_duplicate_' . $form->ID)); ?>"><span class="dashicons dashicons-admin-page"></span><?php esc_html_e('Duplicate', 'formorbit'); ?></a></span><span class="trash"><button type="button" class="button-link-delete webform-delete" data-id="<?php echo esc_attr($form->ID); ?>"><span class="dashicons dashicons-trash"></span><?php esc_html_e('Trash', 'formorbit'); ?></button></span></div>
                                <?php endif; ?>
                                </div></div>
                            ...
                            <td data-colname="<?php esc_attr_e('Entries', 'formorbit'); ?>"><a class="webform-count-link" href="<?php echo esc_url(admin_url('admin.php?page=webform-entries&form_id=' . $form->ID)); ?>"><?php echo esc_html($this->entry_count($form->ID)); ?></a></td>
        ...
        <div class="wrap webform-wrap webform-builder-wrap">
            ...
            <div class="webform-builder">
                <aside class="webform-field-picker" id="webform-field-picker" aria-hidden="true">
                    ...
                    <?php endif; ?>
                    <?php if (!$this->is_pro_active()) : ?><div class="webform-picker-pro"><div><span class="webform-pro-badge"><?php esc_html_e('RECOMMENDED PRO', 'formorbit'); ?></span><h3><?php esc_html_e('Build revenue and automated workflows', 'formorbit'); ?></h3><p><?php esc_html_e('Upgrade for calculated totals, grouped layouts, signatures, PDF notifications, hosted payments, email marketing, automation, premium styles, and 20 business templates.', 'formorbit'); ?></p></div><h4><?php esc_html_e('Pro fields', 'formorbit'); ?></h4><div class="webform-pro-field-list"><div><span class="dashicons dashicons-editor-table"></span><?php esc_html_e('Calculations', 'formorbit'); ?></div><div><span class="dashicons dashicons-grid-view"></span><?php esc_html_e('Field groups', 'formorbit'); ?></div><div><span class="dashicons dashicons-edit"></span><?php esc_html_e('E-signatures', 'formorbit'); ?></div><div><span class="dashicons dashicons-editor-paste-word"></span><?php esc_html_e('Rich text / contracts', 'formorbit'); ?></div></div><h4><?php esc_html_e('Pro integrations', 'formorbit'); ?></h4><div class="webform-pro-field-list webform-pro-integration-fields"><div><span class="dashicons dashicons-email"></span>Mailchimp</div><div><span class="dashicons dashicons-megaphone"></span>Brevo</div><div><span class="dashicons dashicons-randomize"></span>Zapier</div><div><span class="dashicons dashicons-money-alt"></span><?php esc_html_e('Stripe / PayPal', 'formorbit'); ?></div></div><a class="button button-primary" href="<?php echo esc_url($this->upgrade_url('field-picker')); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e('See everything in Pro — $19.99/year', 'formorbit'); ?></a></div><?php endif; ?>
                    </div>
                    <?php if (!$this->is_pro_active()) : ?>
                        <div class="webform-picker-pro webform-pro-field-preview-only">
                            <h4><?php esc_html_e('More fields in FormOrbit Pro', 'formorbit'); ?></h4>
                            <div class="webform-pro-field-list">
                                <div><span class="dashicons dashicons-location-alt"></span><?php esc_html_e('Address', 'formorbit'); ?></div>
                                <div><span class="dashicons dashicons-list-view"></span><?php esc_html_e('Repeater', 'formorbit'); ?></div>
                                <div><span class="dashicons dashicons-calendar-alt"></span><?php esc_html_e('Appointment', 'formorbit'); ?></div>
                                <div><span class="dashicons dashicons-chart-line"></span><?php esc_html_e('NPS score', 'formorbit'); ?></div>
                                <div><span class="dashicons dashicons-money-alt"></span><?php esc_html_e('Currency', 'formorbit'); ?></div>
                                <div><span class="dashicons dashicons-editor-paste-word"></span><?php esc_html_e('Rich text / contracts', 'formorbit'); ?></div>
                                <div><span class="dashicons dashicons-lock"></span><?php esc_html_e('Advanced uploads', 'formorbit'); ?></div>
                            </div>
                        </div>
                    <?php endif; ?>
                </aside>
                ...
                <aside class="webform-properties">
                    ...
                    <?php if (!$this->is_pro_active()) : ?><div class="webform-pro-readonly-note"><strong><?php esc_html_e('More confirmation tools in FormOrbit Pro', 'formorbit'); ?></strong><ul><li><?php esc_html_e('Save & Continue with secure resume links', 'formorbit'); ?></li><li><?php esc_html_e('Custom confirmation emails for visitors', 'formorbit'); ?></li><li><?php esc_html_e('PDF submission attachments', 'formorbit'); ?></li></ul></div><?php endif; ?>
                    ...
                    <div class="webform-preset-preview-modal" id="webform-preset-preview-modal" hidden><button type="button" class="webform-preset-preview-backdrop" aria-label="<?php esc_attr_e('Close preview', 'formorbit'); ?>"></button><div class="webform-preset-preview-dialog" role="dialog" aria-modal="true" aria-labelledby="webform-preset-preview-title"><div class="webform-preset-preview-head"><div><small><?php esc_html_e('STYLE PREVIEW', 'formorbit'); ?></small><h2 id="webform-preset-preview-title"></h2></div><button type="button" class="button webform-preset-preview-close" aria-label="<?php esc_attr_e('Close preview', 'formorbit'); ?>">×</button></div><div class="webform-public webform-preset-preview-form"><div class="webform-progress"><div class="webform-progress-bar" style="width:52%"></div></div><ol class="webform-steps"><li class="is-active"><?php esc_html_e('Your details', 'formorbit'); ?></li><li><?php esc_html_e('Finish', 'formorbit'); ?></li></ol><div class="webform-stage is-active"><h2><?php esc_html_e('Tell us about yourself', 'formorbit'); ?></h2><div class="webform-field"><label><?php esc_html_e('Full name', 'formorbit'); ?> <span>*</span></label><input type="text" value="<?php esc_attr_e('Jane Smith', 'formorbit'); ?>" readonly></div><fieldset class="webform-field"><legend><?php esc_html_e('Preferred service', 'formorbit'); ?></legend><div class="webform-choices"><label><input type="radio" checked disabled> <?php esc_html_e('Consultation', 'formorbit'); ?></label><label><input type="radio" disabled> <?php esc_html_e('Project estimate', 'formorbit'); ?></label></div></fieldset><div class="webform-field"><label><?php esc_html_e('Message', 'formorbit'); ?></label><textarea readonly><?php esc_html_e('This is how your form text and fields will look.', 'formorbit'); ?></textarea></div><div class="webform-actions"><button type="button"><?php esc_html_e('Continue', 'formorbit'); ?></button></div></div></div></div></div>
    ...
    public function entries_page() {
        ...
        <a class="button" href="<?php echo esc_url(wp_nonce_url(admin_url('admin-post.php?action=webform_export_entries&form_id=' . $form_filter), 'webform_export_entries')); ?>"><?php esc_html_e('Export CSV', 'formorbit'); ?></a></div>
