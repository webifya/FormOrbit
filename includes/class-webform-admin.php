...
class Webform_Admin {
    ...
    public function save_form() {
        ...
        $clean_settings = array(
            ...
            'confirmation_type' => in_array($settings['confirmation_type'] ?? 'message', array('message', 'redirect', 'webhook'), true) ? $settings['confirmation_type'] : 'message',
