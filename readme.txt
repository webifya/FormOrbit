...
= 5.0.2 =
* Automatically refresh expired submission tokens and retry once without clearing entered fields.
* Keep security validation enabled and avoid retrying ambiguous network failures.

= 5.0.1 =
* Fix preview stylesheet loading so the popup does not appear at the page bottom.
* Keep editor scroll position while opening and closing preview.
= 5.0.0 =
